...
import org.joyqueue.network.transport.codec.support.UDPDecoder;
import org.joyqueue.network.transport.codec.support.UDPEncoder;
...
/**
 * UdpProtocolHandlerPipeline
 *
 * author: gaohaoxiang
 * date: 2018/8/13
 */
@ChannelHandler.Sharable
public class UDPProtocolHandlerPipeline extends ChannelInitializer {
    ...
    public UDPProtocolHandlerPipeline(Protocol protocol, CommandDispatcher commandDispatcher, TransportEventHandler transportEventHandler, ConnectionHandler connectionHandler) {
    ...
    protected void initChannel(Channel channel) throws Exception {
        ...
        pipeline.addLast(new UDPDecoder(codec))
                .addLast(new UDPEncoder(codec));
